      ...
      html: `
            ...
            <div class="content-stage" data-stage="1" data-type="activity">
              <div class="contentBox">
                ...
                <p style="margin:0 0 8px; color:#1a1818; font-weight:650;">Tuliskan dugaanmu berdasarkan video yang telah kamu amati!</p>
    ...
    s3: {
      ...
      html: `
            ...
            <div class="content-stage" data-stage="1" data-type="activity">
              <div class="contentBox">
                <h4 style="margin:12px 0 8px;">✍ DUGAAN AWAL</h4>
                <p style="margin:0 0 8px; color:#1a1818; font-weight:650;">Tuliskan dugaanmu berdasarkan ilustrasi yang telah kamu amati!</p>
...
const quizBank = {
  s1: [
    ...
    { q: "Pernyataan: Jika suatu reaksi memiliki nilai ΔH positif, maka reaksi tersebut melepaskan kalor ke lingkungan. ○ Benar ○ Salah", a: ["Benar", "Salah"], correct: 1, hint: "Perhatikan hubungan antara tanda ΔH dengan arah perpindahan kalor pada sistem.", pembahasan: "Nilai ΔH positif menunjukkan bahwa sistem menyerap kalor dari lingkungan, sehingga reaksi bersifat endoterm. Oleh karena itu, pernyataan tersebut salah karena kalor tidak dilepaskan, melainkan diserap oleh sistem." },
  ...
  s2: [
    { q: "Pernyataan: Reaksi NaCl(s) → Na(s) + ½Cl₂(g) merupakan contoh perubahan entalpi pembentukan standar (ΔH°f). ○ Benar ○ Salah", a: ["Benar", "Salah"], correct: 1, hint: "Perhatikan arah panah reaksi. Ke kiri atau ke kanan? Dan apa yang terjadi pada senyawa NaCl?", pembahasan: "Reaksi tersebut menunjukkan senyawa NaCl diuraikan menjadi unsur-unsurnya, sehingga termasuk perubahan entalpi penguraian standar (ΔH°d), bukan perubahan entalpi pembentukan standar (ΔH°f). Reaksi penguraian umumnya memerlukan energi sehingga bersifat endoterm." },
  ...
  s3: [
    ...
    { q: "Pernyataan: Pada suatu percobaan kalorimeter, suhu larutan turun setelah dua zat dicampurkan. Hal tersebut menunjukkan bahwa reaksi bersifat endoterm karena sistem menyerap kalor dari lingkungan. ○ Benar ○ Salah", a: ["Benar", "Salah"], correct: 0, hint: "Perhatikan arah perpindahan kalor. Jika suhu turun, ke mana kalor berpindah?", pembahasan: "Penurunan suhu larutan menunjukkan bahwa sistem menyerap kalor dari lingkungan. Oleh karena itu, reaksi bersifat endoterm dengan ΔH bernilai positif, karena kalor berpindah dari lingkungan ke sistem." },
  ...
  s4: [
    ...
    { q: "Pernyataan: Pada reaksi N\u2082(g) + 3H\u2082(g) \u2192 2NH\u2083(g), energi yang dilepaskan saat pembentukan ikatan N\u2013H lebih besar daripada energi yang diperlukan untuk memutus ikatan pereaksi. Oleh karena itu, reaksi tersebut bersifat endoterm. ○ Benar ○ Salah", a: ["Benar", "Salah"], correct: 1, hint: "Jika energi yang dilepaskan saat pembentukan ikatan lebih besar dari energi yang dibutuhkan untuk memutus ikatan, apa yang terjadi?", pembahasan: "Pemutusan ikatan kimia memerlukan energi, sedangkan pembentukan ikatan melepaskan energi. Jika energi yang dilepaskan saat pembentukan ikatan lebih besar daripada energi yang dibutuhkan untuk memutus ikatan, maka terjadi pelepasan kalor ke lingkungan. Akibatnya, \u0394H bernilai negatif dan reaksi bersifat eksoterm. Oleh karena itu, pernyataan tersebut salah." },
